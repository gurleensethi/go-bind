...
Go HTTP request/response binding library using struct tags. Binds headers, query, path, body, cookies to struct fields. Serializes response structs to HTTP (JSON, text, cookies, headers).
